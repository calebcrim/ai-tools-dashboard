// Navigation JavaScript for Best Practices Hub (Root Level)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    pathCards.forEach(card => {
        ...
        card.addEventListener('click', function(e) {
            ...
            const pathMap = {
                'AI Fundamentals': 'js/components/best-practices/learning-paths/ai-fundamentals.html',
                'Advanced Techniques': 'js/components/best-practices/learning-paths/advanced-techniques.html',
                'Industry Specialization': 'js/components/best-practices/learning-paths/industry-specialization.html'
            };
